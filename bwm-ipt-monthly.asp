...
<content>
	...
	<div id="cstats" class="box">
		<div class="heading">每月 IP 流量 <a class="pull-right" href="#" data-toggle="tooltip" title="Reload Information" onclick="reloadPage(); return false;"><i class="icon-refresh"></i></a></div>
		<div class="content">
	...
	<script type="text/javascript">
		...
		c.push({ title: '日期范围', multi: [ { name: 'f_begin_date', type: 'select', options: [['0', 'Any']], suffix: ' - ' }, { name: 'f_end_date', type: 'select', options: [['0', 'Any']] } ] } );
